Shader "Custom/GrassShader"
{
    Properties
    {
        ...
        _HillFrequency ("Hill Frequency", Range(0.1, 5.0)) = 1.0
        _HillAmplitude ("Hill Amplitude", Range(0.1, 5.0)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _BumpMap_ST; 
            float _LightOn;
            float _HillFrequency;
            float _HillAmplitude;

            
            float generateHills(float x, float z)
            {
                
                float hill = sin(x * _HillFrequency) * cos(z * _HillFrequency);
                return hill * _HillAmplitude; 
            }
            ...
            v2f vert(appdata v)
            {
                ...
                float wave=generateHills(v.vertex.x, v.vertex.z); 
                v.vertex.y += wave; 
